...
class Transaksi extends Models
{
    ...
    {
        $instance = new static();
        return $instance->conn->query("select transaksi.id as \"id\", transaksi.tanggal_transaksi, transaksi.kembalian, transaksi.tunai, transaksi.status_pembayaran, pelanggan.id as \"id_pelanggan\", pelanggan.nama, pelanggan.alamat from {$instance->table}
